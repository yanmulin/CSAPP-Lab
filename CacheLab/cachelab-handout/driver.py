...
def main():
    ...
    csim_cscore_list = list(csim_cscore)
    total_score = csim_cscore_list[0] + trans32_score + trans64_score + trans61_score

    # Summarize the results
    print ("\nCache Lab summary:")
    print ("%-22s%8s%10s%12s" % ("", "Points", "Max pts", "Misses"))
    print ("%-22s%8.1f%10d" % ("Csim correctness", csim_cscore_list[0], 
                              maxscore['csim']))
